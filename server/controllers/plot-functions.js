...
plot_functions.plotHistogramOfColumn = function (dataset, parameters, callback) {
...
plot_functions.plotHistogramOfTwoColumns = function (dataset, parameters, callback) {
...
plot_functions.plotLineChartOfColumn = function (dataset, parameters, callback) {
    let column = parameters[0];
...
plot_functions.plotScatterOfTwoColumns = function (dataset, parameters, callback) {
    let column1 = parameters[0];
    let column2 = parameters[1];
...
plot_functions.plotPieChartOfColumn = function (dataset, parameters, callback) {
    let column = parameters[0];
    // SELECT <column> FROM <dataset>
    bookshelf.Model.extend({tableName: dataset}).fetchAll({columns: [column]}).then(data => {
